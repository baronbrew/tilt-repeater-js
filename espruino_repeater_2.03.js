...
function startScan (){
  NRF.setScan(function(d) {
    ...
    if (hexData.substr(8,4) == 'bb' + color + '0'){//matches key portion of iBeacon UUID for a Tilt
      ...
      NRF.setAdvertising(require("ble_ibeacon").get({ uuid : [0xa4, 0x95, 0xbb, uuidValue, 0xc5, 0xb1, 0x4b, 0x44, 0xb5, 0x12, 0x13, 0x70, 0xf0, 0x2d, 0x74, 0xde], major : majorValue, minor : minorValue, rssi : -59 }),{interval:1000, connectable:false});
      cycleCount = 0;
      scanCounter = 0;
    }
  ...
  if (cycleCount > 239){//reset iBeacon after 2 hours not connecting
    cycleCount = 0;
    NRF.setAdvertising(require("ble_ibeacon").get({ uuid : [0xa4, 0x95, 0xbb, startingUUID, 0xc5, 0xb1, 0x4b, 0x44, 0xb5, 0x12, 0x13, 0x70, 0xf0, 0x2d, 0x74, 0xde], major : 0, minor : 0, rssi : -59 }),{interval:1000, connectable:false});
  }
  scanCounter++;
...
clearInterval();
clearTimeout();
//name not needed, start connectable
NRF.setAdvertising({},{ showName: false, connectable:true });
setWatch(function() {
  ...
  NRF.setAdvertising(require("ble_ibeacon").get({ uuid : [0xa4, 0x95, 0xbb, startingUUID, 0xc5, 0xb1, 0x4b, 0x44, 0xb5, 0x12, 0x13, 0x70, 0xf0, 0x2d, 0x74, 0xde], major : 0, minor : 0, rssi : -59 }),{interval:500, connectable:false});
